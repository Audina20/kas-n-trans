  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        if (isset($_POST['cari'])){
          $bulan_pembayaran = mysqli_query($conn, "SELECT * FROM bulan_pembayaran WHERE nama_bulan LIKE '%$_POST[cari]%' OR tahun LIKE '%$_POST[cari]%' ORDER BY tahun ASC");
        }
        ...
        <div class="row">
          ...
          foreach ($bulan_pembayaran as $index => $dbp):
            ...
            if ((isset($tahun[$index]) == isset($tahun[$index -1]))) {
              $tahun[] = $dbp['tahun'];
            }
