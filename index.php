<?php 
  ...
  checkLogin();
  $jml_anggota = mysqli_fetch_assoc(mysqli_query($conn, "SELECT count(id_anggota) as jml_anggota FROM anggota"));
  $jml_anggota = $jml_anggota['jml_anggota'];
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-lg-3">
            <div class="card shadow">
              <div class="card-body">
                ...
                <h6 class="text-muted">Jumlah Anggota: <?= $jml_anggota; ?></h6>
                <a href="anggota.php" class="btn btn-info"><i class="fas fa-fw fa-align-justify"></i></a>
              </div>
            </div>
          </div>
          <div class="col-lg-3">
          ...
          <div class="col-lg-3">
            <div class="card shadow">
              <div class="card-body">
                <h5><i class="text-success fas fa-fw fa-caret-up"></i> <i class="text-success fas fa-fw fa-dollar-sign"></i> Saldo</h5>
                <h6 class="text-muted">Total Saldo: Rp. <?= number_format($jml_uang_kas - $jml_pengeluaran); ?></h6>
